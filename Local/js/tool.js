var testTool = {
  getNames: function() {
    var names = new Array(5); // create an empty array with length 45
    var id = 0;
    // const allFileContents = fs.readFileSync('/Users/in-prkalagara/sample-app-web/Local/names.txt', 'utf-8');
  ...
  getMeetingConfigCustom: function() {
